...
- `docs.yml` builds the Sphinx-Gallery example gallery from `examples/gallery/` and publishes it to GitHub Pages. It is path-filtered so README-only changes do not redeploy the gallery.
