...
- `publish-pypi.yml` builds and publishes the package to PyPI when a GitHub Release is published. It uses PyPI Trusted Publishing and does not require storing a PyPI token in GitHub.
